...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header d-block">
				<button type="button" class="btn btn-primary" onclick="window.location.href='<?= base_url().'admin_side/tambah_data_tangki'; ?>'"><i class="ik ik-plus"></i>Tambah Data</button>
            </div>
                    ...
                    <script type="text/javascript" language="javascript" >
                        $(document).ready(function(){
                            $('#tbl').dataTable({
                                ...
                                "bProcessing": true,
                                "ajax" : {
                                    url:"<?= site_url('admin/Master/json_data_tangki'); ?>"
                                },
                                "aoColumns": [
