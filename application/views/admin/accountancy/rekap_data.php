                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl1').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_1'); ?>"
                                        },
                                        "aoColumns": [
                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl2').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_2'); ?>"
                                        },
                                        "aoColumns": [
                                                    { mData: 'no', sClass: "alignCenter" },
                                                    { mData: 'nama' },
                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl3').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_3'); ?>"
                                        },
                                        "aoColumns": [
                                                    { mData: 'no', sClass: "alignCenter" },
                                                    { mData: 'tl' },
                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl4').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_4'); ?>"
                                        },
                                        "aoColumns": [
                                                    { mData: 'no', sClass: "alignCenter" },
                                                    { mData: 'nama' },
                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl5').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_5'); ?>"
                                        },
                                        "aoColumns": [
                                                    { mData: 'no', sClass: "alignCenter" },
                                                    { mData: 'nama' },
                            ...
                            <script type="text/javascript" language="javascript" >
                                $(document).ready(function(){
                                    $('#tbl6').dataTable({
                                        ...
                                        "bProcessing": true,
                                        "ajax" : {
                                            url:"<?= site_url('admin/Accountancy/json_data_pengguna_role_6'); ?>"
                                        },
                                        "aoColumns": [
                                                    { mData: 'no', sClass: "alignCenter" },
                                                    { mData: 'nama' },
