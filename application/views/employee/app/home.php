                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="kt-widget11__title">Loop</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="kt-widget11__title">Selto</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="kt-widget11__title">Jippo</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="kt-widget11__title">Verto</a>
                    ...
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        ...
                        <ul class="kt-nav">
                            ...
                            <li class="kt-nav__foot">
                                <a class="btn btn-label-danger btn-bold btn-sm" href="javascript:void(0)">Upgrade plan</a>
                ...
                <div class="kt-widget4">
                    <div class="kt-widget4__item">
                        ...
                        <div class="kt-widget4__tools">
                            <a href="javascript:void(0)" class="btn btn-clean btn-icon btn-sm">
                    ...
                    <div class="tab-pane active" id="kt_widget4_tab1_content">
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-brand btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-warning btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-danger btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-success btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-primary btn-bold">Follow</a>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="kt_widget4_tab2_content">
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-success">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-brand">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-danger">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<?= base_url(); ?>assets/media/users/100_2.jpg" alt="">
                            ...
                            <div class="kt-widget4__item">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-label-info">Follow</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-4 col-lg-6 order-lg-1 order-xl-1">
        ...
        <div class="kt-portlet kt-portlet--height-fluid">
            <div class="kt-portlet__head">
                ...
                <div class="kt-portlet__head-toolbar">
                    <a href="javascript:void(0)" class="btn btn-label-brand btn-sm  btn-bold dropdown-toggle" data-toggle="dropdown">
                        Latest
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
                            ...
                            <div class="kt-list-timeline">
                                <div class="kt-list-timeline__items">
                                    ...
                                    <div class="kt-list-timeline__item">
                                        ...
                                        <span class="kt-list-timeline__text">System error - <a href="javascript:void(0)" class="kt-link">Check</a></span>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(<?= base_url(); ?>assets/media//products/product4.jpg)">
                    ...
                    <div class="kt-widget19__labels">
                        <a href="javascript:void(0)" class="btn btn-label-light-o2 btn-bold ">Recent</a>
                    </div>
                </div>
            </div>
            <div class="kt-portlet__body">
                ...
                <div class="kt-widget19__action">
                    <a href="javascript:void(0)" class="btn btn-sm btn-label-brand btn-bold">Read More...</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                        ...
                        <div class="kt-timeline-v2__item">
                            ...
                            <div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                <a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/media/users/100_4.jpg" title=""></a>
                                <a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/media/users/100_13.jpg" title=""></a>
                                <a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/media/users/100_11.jpg" title=""></a>
                                <a href="javascript:void(0)"><img src="<?= base_url(); ?>assets/media/users/100_14.jpg" title=""></a>
                            </div>
                        </div>
                        <div class="kt-timeline-v2__item">
                            ...
                            <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                Make Deposit <a href="javascript:void(0)" class="kt-link kt-link--brand kt-font-bolder">USD 700</a> To ESL.
                            </div>
                        </div>
                        <div class="kt-timeline-v2__item">
                        ...
                        <div class="kt-timeline-v2__item">
                            ...
                            <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                Placed a new order in <a href="javascript:void(0)" class="kt-link kt-link--brand kt-font-bolder">SIGNATURE MOBILE</a> marketplace.
                            </div>
                        </div>
                        <div class="kt-timeline-v2__item">
                            <span class="kt-timeline-v2__item-time">16:00</span>
                        ...
                        <div class="kt-timeline-v2__item">
                            ...
                            <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                Received a new feedback on <a href="javascript:void(0)" class="kt-link kt-link--brand kt-font-bolder">FinancePro App</a> product.
                            </div>
                        </div>
                        <div class="kt-timeline-v2__item">
                            ...
                            <div class="kt-timeline-v2__item-text kt-padding-top-5">
                                New notification message has been received on <a href="javascript:void(0)" class="kt-link kt-link--brand kt-font-bolder">LoopFin Pro</a> product.
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="kt-timeline-v3__item kt-timeline-v3__item--info">
                                    ...
                                    <div class="kt-timeline-v3__item-desc">
                                        ...
                                        <span class="kt-timeline-v3__item-user-name">
                                            <a href="javascript:void(0)" class="kt-link kt-link--dark kt-timeline-v3__itek-link">
                                                By Bob
                                            </a>
                                        </span>
                                    </div>
