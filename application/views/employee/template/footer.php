					...
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								2020&nbsp;&copy;&nbsp;<a href="javascript:void(0)" target="_blank" class="kt-link">PFDA</a>
							</div>
		...
		<div id="kt_quick_panel" class="kt-quick-panel">
			<a href="javascript:void(0)" class="kt-quick-panel__close" id="kt_quick_panel_close_btn"><i class="flaticon2-delete"></i></a>
		...
		<script src="<?= base_url(); ?>assets/js/pages/crud/forms/widgets/bootstrap-daterangepicker.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
